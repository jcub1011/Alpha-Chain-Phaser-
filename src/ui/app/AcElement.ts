/*
 * Shared base for every Alpha Chain component. Two decisions live here:
 *  1. Light DOM (`createRenderRoot` returns `this`) so the global stylesheet and
 *     cross-tree queries (the score replay measuring real card elements) work.
...
export class AcElement extends LitElement {
