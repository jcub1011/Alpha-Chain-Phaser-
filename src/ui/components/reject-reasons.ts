 ...
 * <ac-word-builder> in Word Builder — and a copy in each is how the two drift. The `Record` is
...
export const REJECT_REASON: Record<NonNullable<SubmitResult["reason"]>, string> = {
  ...
  // Word Builder only: the Tile Rack is the authority on what is playable
  "not-constructible": "You don't have the tiles for that",
};
